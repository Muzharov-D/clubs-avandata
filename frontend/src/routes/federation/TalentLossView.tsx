...
export function FederationTalentLoss() {
  ...
  return (
    <div className="fed-stack">
      ...
      <FedSection title="Перекос по когортам" hint="отношение числа рождённых в начале года к рождённым в конце">
        <AgeEffectBody />
      </FedSection>

      {/* 2) Пирамида лиг — где осели поздно-рождённые (по региону) */}
      <FedSection title="Пирамида лиг" hint="два эшелона · в разрезе региона">
        <PyramidBody />
      </FedSection>

      {/* 3) Карта возможностей — кого из выживших не выпускают (по региону) */}
      <FedSection title="Карта возможностей" hint="распределение игрового времени · в разрезе региона">
        <BuriedBody />
      </FedSection>
    </div>
  );
