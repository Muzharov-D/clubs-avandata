  ...
  return (
    <div>
      ...
      <section>
        ...
        <p className="fed-note" style={{ marginBottom: 24 }}>Меры регулятора · выводимы из показателей выше</p>
        <AvoidLossBody />
      </section>
    </div>
  );
...
function AvoidLossBody() {
  ...
  const recs: Recommendation[] = [
    {
      title: 'Возрастные квоты и био-беннинг при отборе',
      rationale: maxC
    ...
    },
    {
      ...
      rationale: q4 != null
        ? `Медиана игрового времени Q4 — ${q4.medianTime}% против старших кварталов: пересмотреть переходы между эшелонами так, чтобы нижние лиги оставались путём роста, а не тупиком для рождённых в конце года.`
        : 'Пересмотреть переходы между эшелонами так, чтобы нижние лиги оставались путём роста для поздно рождённых, а не тупиком отбора по физической зрелости.',
    },
    {
