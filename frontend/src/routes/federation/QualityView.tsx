      ...
      <section className="fed-card">
        ...
        {isLoading ? (
          ...
          <>
            ...
            {noCohort ? (
              <p className="fed-note">Сборная для этого года не считается — основная сборная региона строится только для 2009–2013 г.р.</p>
            ) : xiTally.length === 0 ? (
