// === LEGIRUS REFERENCE (verbatim) — frontend/src/utils/legirus.js ===
// Для задач Task Master #4 (team IDs / убрать includes()), #7 (нормализация в одной точке),
// #8 (общий util). Контракт §13.4 блюпринта. При порте: → tenantNorm.ts, алиасы из tenants.provider_config.
