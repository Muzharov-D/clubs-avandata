// === LEGIRUS REFERENCE (verbatim) — frontend/src/utils/players.js ===
// Для задач #8 (общий util shortName), #9 (дедуп формации по стабильному выбору, не по номер-фамилия).
// pickBest решает кейс дублей legacy+ffspb: показывать игрока с фото и правильным id.
