// === LEGIRUS REFERENCE (verbatim) — frontend/src/utils/dates.js ===
// UX-контракт §13.4: countdown МИНУТНЫЙ (не секундный — мобильный throttle setInterval(1s)
// делает секунды рваными). Все даты в Europe/Moscow. Для общего util-модуля (#8).
